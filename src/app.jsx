...
const RESEARCH = {
  decodingtrust: {
    ...
    blurb: "What undefended models actually do — toxic and biased outputs, privacy leakage, and susceptibility to jailbreaks.",
  ...
  dtap: {
    ...
    blurb: "How fully automated red-teaming surfaces vulnerabilities a one-time manual review misses.",
  ...
  mastrike: {
    ...
    blurb: "How role-specialized agents get compromised through collusion and privilege escalation.",
  ...
  devopsgym: {
    ...
    blurb: "How today's AI agents really perform across build, monitoring, issue resolving, and test generation.",
